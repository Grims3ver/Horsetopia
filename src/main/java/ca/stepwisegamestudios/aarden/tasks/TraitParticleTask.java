package ca.stepwisegamestudios.aarden.tasks;

import ca.stepwisegamestudios.aarden.Horsetopia;
import ca.stepwisegamestudios.aarden.traits.TraitParticleResolver;
...
public class TraitParticleTask implements Runnable {
    ...
    private final Horsetopia plugin = Horsetopia.getInstance();
