package ca.stepwisegamestudios.aarden.growing;
...
public class HorseGrowthManager {
    ...
    public HorseGrowthManager(Horsetopia plugin) {
    ...
    public void start() {
        ...
        if (!config.getBoolean("horse-growth-settings.enabled")) {
            ...
            }.runTask(Horsetopia.getInstance());
            return;
        }
        ...
        }.runTaskTimer(Horsetopia.getInstance(), 0L, intervalTicks);
    }
