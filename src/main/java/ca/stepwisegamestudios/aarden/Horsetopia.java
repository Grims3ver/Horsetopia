package ca.stepwisegamestudios.aarden;

import ca.stepwisegamestudios.aarden.listeners.*;
import ca.stepwisegamestudios.aarden.utils.SupportedMountType;
import com.comphenix.protocol.ProtocolLibrary;
import com.comphenix.protocol.ProtocolManager;
import ca.stepwisegamestudios.aarden.commands.CustomHorseCommand;
import ca.stepwisegamestudios.aarden.commands.HorseCommand;
import ca.stepwisegamestudios.aarden.commands.HorseCommandCompleter;
import ca.stepwisegamestudios.aarden.commands.HorseCreateTabCompleter;
import ca.stepwisegamestudios.aarden.growing.HorseGrowthManager;
import ca.stepwisegamestudios.aarden.language.LanguageManager;
import ca.stepwisegamestudios.aarden.listeners.*;
import ca.stepwisegamestudios.aarden.tasks.TraitParticleTask;
...
public class Horsetopia extends JavaPlugin {

    private static Horsetopia instance;
    ...
    public static Horsetopia getInstance() {
        return instance;
    }
    ...
    private boolean isHorseTrampleEnabled(FileConfiguration config) {
        for (SupportedMountType mountType : SupportedMountType.values()) {
